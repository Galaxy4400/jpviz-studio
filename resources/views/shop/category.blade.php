...
@section('content')
	<div class="shop">
		<div class="shop__container _container">
			<div class="shop__body shop__body_no-aside">
				...
				<div class="shop__content">
					<div class="shop-cards">
						<div class="shop-cards__body">
							@each('shop.partials.product-card', $category->products, 'product')
						</div>
					</div>
				</div>
				<div class="pagging">
					<ul class="pagging__list">
						...
						<li class="pagging__item">
							<a class="pagging__link _active" href="">4</a>
						</li>
						<li class="pagging__item">
						...
						<li class="pagging__item">
							<a class="pagging__link" href="">10</a>
						</li>
					</ul>
				</div>
			</div>
